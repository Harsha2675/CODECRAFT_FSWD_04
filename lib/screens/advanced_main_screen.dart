              ...
              return Card(
                child: ListTile(
                  leading: CircleAvatar(
                    backgroundColor: _currentRoom?.id == room.id ? Colors.green : Colors.blue,
          ...
          Flexible(
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isMe ? Colors.blue : (_isDarkMode ? Colors.grey[700] : Colors.grey.shade300),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                _buildFileOption(Icons.image, 'Image', Colors.blue, () => _sendFileMessage('📷 Image.jpg', MessageType.image)),
